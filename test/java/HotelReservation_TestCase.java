...
public class HotelReservation_TestCase {
    ...
    @Test
    public void getHotelNameAndPrice_Validation()
    {
        HotelReservation ob = new HotelReservation("Lakewood",110.0, parseDate("10/Sep/2020"), parseDate("11/Sep/2020"));
        Assert.assertEquals("Lakewood", ob.hotelName);
        Assert.assertEquals(110.0, ob.price);
        HotelReservation ob1 = new HotelReservation("Lakewood",160.0,parseDate("10/sep/2020"), parseDate("11/sep/2020"));
        Assert.assertEquals("Lakewood", ob1.hotelName);
        Assert.assertEquals(160.0, ob1.price);
        HotelReservation ob2 = new HotelReservation("Lakewood",210.0, parseDate("10/Sep/2020"), parseDate("11/Sep/2020"));
    ...
    {
        HotelReservation ob1=new HotelReservation("Lakewood",110.0,parseDate("10/sep/2020"),parseDate("11/sep/2020"));//actual
        HotelReservation ob2=new HotelReservation("Bridgewood", 160.0,parseDate("10/sep/2020"),parseDate("11/sep/2020"));//actual
        HotelReservation ob3=new HotelReservation("Ridgewood", 210.0,parseDate("10/sep/2020"),parseDate("11/sep/2020"));//actual
